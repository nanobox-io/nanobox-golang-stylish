...
func TestNest(t *testing.T) {
	...
	// offset the message by each newline lenght in this type of thing warnings add
	// 2 new lines
	...
	// offset the message by each newline lenght in this type of thing errors add
	// 3 new lines
